<?php include('header.html'); ?>
		...
		<div id="thetext">
				<h1>Eteriska oljor</h1>
				<p class="intro">Beroende på behov och önskad effekt tillsätts eteriska oljor. Allt för att skräddarsy produkten så att den passar just Dig.<br />
